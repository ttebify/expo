...
Development builds can be created with [EAS Build](/build/introduction/) or locally on your computer, if you have Xcode and Android Studio.
...
## Run a development build on emulator/simulator
...
## Run a development build on the device
