---
title: Animation
description: Learn how to integrate react-native-reanimated library and use it in your Expo project.
---
...
Other animation packages are available, such as moti, that you also use in your Expo project and work on Android, iOS, and the web. For more information on its API and usage, see [moti documentation](https://moti.fyi/).
