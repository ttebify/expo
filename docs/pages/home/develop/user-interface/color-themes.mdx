...
In development builds, you'll need to install the native package [`expo-system-ui`](/versions/latest/sdk/system-ui/#installation) otherwise the `userInterfaceStyle` property will be ignored. You can also the following command to check if the project is misconfigured:
