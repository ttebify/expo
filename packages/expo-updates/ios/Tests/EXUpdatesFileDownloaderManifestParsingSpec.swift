  ...
  override func spec() {
    ...
    describe("manifest parsing") {
      it("JSON body") {
        ...
        var resultUpdateManifest: EXUpdatesUpdate? = nil
      ...
      it("json body signed") {
        let config = EXUpdatesConfig.config(fromDictionary: [
          EXUpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://exp.host/@test/test",
          EXUpdatesConfig.EXUpdatesConfigCodeSigningCertificateKey: modernJSONCertificate,
      ...
      it("multipart body") {
        ...
        let bodyData = EXUpdatesFileDownloaderManifestParsingSpec.mutlipartData(
      ...
      it("json body signed unsigned request manifest signature optional") {
        let config = EXUpdatesConfig.config(fromDictionary: [
          ...
          EXUpdatesConfig.EXUpdatesConfigCodeSigningCertificateKey: modernJSONCertificate,
          EXUpdatesConfig.EXUpdatesConfigCodeSigningMetadataKey: [:],
          EXUpdatesConfig.EXUpdatesConfigCodeSigningAllowUnsignedManifestsKey: true
        ])
        let downloader = EXUpdatesFileDownloader(config: config)
        let contentType = "application/json"
        let response = HTTPURLResponse(
      ...
      it("multipart body signed certificate particular experience") {
        let config = EXUpdatesConfig.config(fromDictionary: [
          EXUpdatesConfig.EXUpdatesConfigUpdateUrlKey: "https://exp.host/@test/test",
          EXUpdatesConfig.EXUpdatesConfigCodeSigningCertificateKey: rootCertificate,
          EXUpdatesConfig.EXUpdatesConfigCodeSigningMetadataKey: [
            "keyid": "ca-root",
          ],
          EXUpdatesConfig.EXUpdatesConfigCodeSigningIncludeManifestResponseCertificateChainKey: true
        ])
        let downloader = EXUpdatesFileDownloader(config: config)
